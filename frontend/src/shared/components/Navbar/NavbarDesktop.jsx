  ...
  return (
    <div className="flex items-center justify-between h-20">
      ...
      <div className="hidden lg:flex items-center gap-1">
        <Link
          to="/"
          className="relative px-5 py-2.5 text-gray-700 font-medium text-sm tracking-wide hover:text-emerald-600 transition-all duration-300 group"
        >
          Home
      ...
      <div className="flex items-center gap-3">
        {/* Search Bar */}
        <div
          className={`relative flex items-center transition-all duration-300 ${searchFocused ? "w-80" : "w-64"}`}
        >
          <div
            className={`absolute inset-0 rounded-full transition-all duration-300 ${searchFocused ? "bg-white shadow-lg shadow-emerald-100/50 ring-2 ring-emerald-400" : "bg-gray-50/80 border border-gray-200/80"}`}
          ></div>
          <Search
            className={`absolute left-4 z-10 transition-colors duration-300 ${searchFocused ? "text-emerald-500" : "text-gray-400"}`}
            size={18}
          />
          <input
            type="text"
